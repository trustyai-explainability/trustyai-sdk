...
class KubernetesClientSingleton:
    """Singleton class for managing a shared Kubernetes client instance."""
    ...
    def initialize(self, kubeconfig: str | None = None, context: str | None = None) -> bool:
    ...
    @property
    def client(self):
        """Get the kubernetes client module."""
    ...
    def custom_objects_api(self):
        """Get the kubernetes custom objects API."""
        if not self._initialized:
            raise RuntimeError("Kubernetes client not initialized. Call initialize() first.")
...
kubernetes_client = KubernetesClientSingleton()
...
class KubernetesDeployer:
    ...
    def _initialize_client(self) -> bool:
        ...
        Returns:
            True if successful, False otherwise
        """
        return kubernetes_client.initialize(self.kubeconfig, self.context)

    @property
    def _client(self):
        """Get the kubernetes client module."""
        return kubernetes_client.client

    @property
    def _api_client(self):
        """Get the kubernetes API client."""
        return kubernetes_client.api_client

    @property
    def _custom_objects_api(self):
        """Get the kubernetes custom objects API."""
        return kubernetes_client.custom_objects_api

    def deploy_resource(self, resource: KubernetesResource) -> tuple[bool, str | None]:
    ...
    def deploy_lm_eval_job(self, resource: KubernetesResource) -> tuple[bool, str | None]:
